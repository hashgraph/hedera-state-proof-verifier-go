...
The Hedera State Proof Verifier accepts contributions via GitHub pull requests. This document outlines the
...
- [Issues](https://github.com/hashgraph/hedera-state-proof-verifier-go/issues)
...
[GitHub issues](https://github.com/hashgraph/hedera-state-proof-verifier-go/issues). However, if
...
There are 3 types of issues (each with their own corresponding [label](https://github.com/hashgraph/hedera-state-proof-verifier-go/labels)):
...
1. Fork the [hedera-state-proof-verifier-go](https://github.com/hashgraph/hedera-state-proof-verifier-go) repo

Go to the [project](https://github.com/hashgraph/hedera-state-proof-verifier-go) page then hit the `Fork`
...
```sh
$ git clone https://github.com/$your_github_account/hedera-state-proof-verifier-go.git   
```
3. Add an `upstream` remote to keep your fork in sync with the main repo.
```sh
$ cd hedera-state-proof-verifier-go
$ git remote add upstream https://github.com/hashgraph/hedera-state-proof-verifier-go.git
$ git remote -v

origin  https://github.com/$your_github_account/hedera-state-proof-verifier-go.git (fetch)
origin  https://github.com/$your_github_account/hedera-state-proof-verifier-go.git (push)
upstream        https://github.com/hashgraph/hedera-state-proof-verifier-go.git (fetch)
upstream        https://github.com/hashgraph/hedera-state-proof-verifier-go.git (push)
```
